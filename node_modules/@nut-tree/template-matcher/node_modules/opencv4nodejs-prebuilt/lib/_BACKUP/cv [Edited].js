...
const requirePath = path.join(__dirname, "../build/Release/opencv4nodejs");
...
console.log(">>>");
console.log(cv.isWin);
console.log(">>>");
console.log(haarCascades);
console.log(">>>");
console.log(cv.haarCascades);
console.log(">>>");
console.log(lbpCascades);
console.log(">>>");
console.log(cv.lbpCascades);
console.log(">>>");
